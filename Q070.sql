...
SELECT
numer.agency, numer.arid, sold_prev, sold, sold_prev/count_prev::REAL AS pct_sold_prev, sold/count_curr::REAL AS pct_sold, ((sold-sold_prev)/sold_prev::REAL)*100 AS pct_change
...
WHERE (CASE WHEN sold_prev/count_prev::REAL*100THEN 1
